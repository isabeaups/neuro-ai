...
def parse_arguments(args_list: Optional[List] = None) -> argparse.Namespace:
    ...
    # Data Factory
    parser.add_argument(
        "--train_data", type=str, default="data/mnist/train-images.idx3-ubyte"
    )
    parser.add_argument(
        "--train_label", type=str, default="data/mnist/train-labels.idx1-ubyte"
    )
    parser.add_argument(
        "--test_data", type=str, default="data/mnist/test-images.idx3-ubyte"
    )
    parser.add_argument(
        "--test_label", type=str, default="data/mnist/test-labels.idx1-ubyte"
    )
    ...
    parser.add_argument(
        "--ext_train_data", type=str, default="data/ext_mnist/train-images.idx3-ubyte"
    )
    parser.add_argument(
        "--ext_train_label", type=str, default="data/ext_mnist/train-labels.idx1-ubyte"
    )
    parser.add_argument(
        "--ext_test_data", type=str, default="data/ext_mnist/test-images.idx3-ubyte"
    )
    parser.add_argument(
        "--ext_test_label", type=str, default="data/ext_mnist/test-labels.idx1-ubyte"
    )
    ...
    parser.add_argument(
        "--ext_train_fname", type=str, default="data/ext_mnist/ext_mnist_train.csv"
    )
    parser.add_argument(
        "--ext_test_fname", type=str, default="data/ext_mnist/ext_mnist_test.csv"
    )
    ...
    args: argparse.Namespace = (
        parser.parse_args() if args_list == None else parser.parse_args(args_list)
    )
