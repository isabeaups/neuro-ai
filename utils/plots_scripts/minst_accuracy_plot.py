...
def plot_accuracy_trends(df, title):
    mnist_experiments = ["MNIST_0_1", "MNIST_2_3", "MNIST_4_5", "MNIST_6_7", "MNIST_8_9"]
...
def main():
    ...
    experiments = [d for d in os.listdir(results_folder) if os.path.isdir(os.path.join(results_folder, d))]
